...
const brands = {
  ...
  b: ["BEARBRAND", "BENG-BENG", "BRAVO!", "BREEZE", "BUTTER CREAM"],
  c: ["CARE FREE", "CDO", "CENTURY TUNA", "CHAMPI", "CHAMPION", "CHOOEY", "CHUCKIE", "CLEARMEN", "CLOSE-UP", "COBRA", "COCA COLA", "COCO PANDAN", "COFFEE-MATE", "COLGATE", "COMBI", "CREAM SILK", "CRISPY FRY"],
  d: ["DATU PUTI", "DEL MONTE", "DELIMONDO", "DOVE", "DOWNY"],
  e: ["EMPERADOR", "ENERGEN", "EQ"],
  f: ["FITA", "FRES", "FRUTOS", "FUDGEE BARR"],
  g: ["GATORADE", "GINISA", "GOLDEN FIESTA", "GREAT TASTE"],
  h: ["HANSEL", "HAPEE", "HAPI FIESTA", "HAPPY", "HERMANO", "HOKKAIDO", "HUNTS"],
  i: ["ICOOL"],
  j: ["JOHNSONS BABY","JOLLY", "JOY",],
  k: ["KNORR", "KOPIKO", "KRAFT"],
  l: ["LADYS CHOICE", "LIGO", "LIPTON", "LORINS", "LUCKY ME!"],
  m: ["MALING", "MANG TOMAS", "MAXX", "MEGA", "MILO", "MODESS", "MOUNTAIN DEW", "MR.HAT GULAMAN"],
  n: ["NESCAFE", "NESTEA", "NESTLE", "NISSIN"],
  o: ["OFF"],
  p: ["PALMOLIVE", "PAMPERS", "PANTENE", "PAPA", "PERLA", "POTCHI", "PRESTO", "PUREFOODS"],
  r: ["RC", "REBISCO", "REFRESH"],
  s: ["SAFEGUARD", "SAN MARINO", "SAN MIGUEL", "SHIN RAMYUN", "SHINE MASTER", "SILKA", "SILVERSWAN", "SKY FLAKES", "SNOW BEAR", "SNOW MOUNTAIN", "SPEED", "SPRITE", "STARWAX", "SUMMIT", "SUNSILK", "SUPERQ", "SURF"],
  t: ["TANDUAY", "TANG", "TENDER CARE", "THOSE DAYS", "TIDE", "TODAYS"],
  u: ["UFC"],
  v: ["V FRESH"],
  w: ["WHISPER", "WILKINS", "WOWULAM"],
  y: ["YAKISOBA", "YAKULT", "YOUNGS TOWN"],
  z: ["ZESTO", "ZONROX"],
};
