...
const brands = {
  ...
  b: ["BEARBRAND", "BENG-BENG", "BRAVO!", "BREEZE", "BUTTERCREAM"],
  c: ["CAREFREE", "CDO", "CENTURYTUNA", "CHAMPI", "CHAMPION", "CHOOEY", "CHUCKIE", "CLEARMEN", "CLOSE-UP", "COBRA", "COCACOLA", "COCOPANDAN", "COFFEE-MATE", "COLGATE", "COMBI", "CREAMSILK", "CRISPYFRY"],
  d: ["DATUPUTI", "DELMONTE", "DELIMONDO", "DOVE", "DOWNY"],
  e: ["EMPERADOR", "ENERGEN", "EQ"],
  f: ["FITA", "FRES", "FRUTOS", "FUDGEEBARR"],
  g: ["GATORADE", "GINISA", "GOLDENFIESTA", "GREATTASTE"],
  h: ["HANSEL", "HAPEE", "HAPIFIESTA", "HAPPY", "HERMANO", "HOKKAIDO", "HUNTS"],
  i: ["ICOOL"],
  j: ["JOHNSONSBABY","JOLLY", "JOY",],
  ...
  s: ["SAFEGUARD", "SANMARINO", "SANMIGUEL", "SHINRAMYUN", "SHINEMASTER", "SILKA", "SILVERSWAN", "SKYFLAKES", "SNOWBEAR", "SNOWMOUNTAIN", "SPEED", "SPRITE", "STARWAX", "SUMMIT", "SUNSILK", "SUPERQ", "SURF"],
